...
export default {
  ...
  methods: {
    ...
    enterMainPost: function (index) {
      let that = this;
      this.$router.push({
        path: "/StudentCommentAndDiscussNav/StudentDiscuss",
        query: {
    ...
    enterMyMainPost: function () {
      let that = this;
      this.$router.push({
        path: "/StudentCommentAndDiscussNav/StudentAllMainPost",
        query: {
          userid: that.userAccount,
        },
      });
    ...
    enterMyFollowPost: function () {
      let that = this;
      this.$router.push({
        path: "/StudentCommentAndDiscussNav/StudentAllFollowPost",
        query: {
          userid: that.userAccount,
        },
      });
