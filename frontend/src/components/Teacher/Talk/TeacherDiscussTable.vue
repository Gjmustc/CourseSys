          ...
          <el-row>
            <el-col :span="14" class="left-information" style="width: 50%">
              ...
              >
                <div class="clearfix">
                  <span
                    ><strong>{{ mainpost.title }}</strong></span
                  >
                  <el-button
                ...
                >
                  <el-tag size="mini">
                    <span>{{ mainpost.userid }}</span>
                  </el-tag>
                </div>
                <div>
                  <span style="color: gray; font-size: 8px"
                    >发表于-{{ mainpost.posttime }}</span
                  >
                </div>
              </el-card>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    enterMainPost: function (index) {
      let that = this;
      this.$router.push({
        path: "/TeacherCommentAndDiscussNav/TeacherDiscuss",
        query: {
          mainid: that.MainPostList[index].mainid,
          maintitle: that.MainPostList[index].title,
          maincontent: that.MainPostList[index].content,
          mainpostime: that.MainPostList[index].posttime,
        },
      });
    },
    enterMyMainPost: function () {
      let that = this;
      this.$router.push({
        path: "/TeacherCommentAndDiscussNav/TeacherAllMainPost",
        query: {
          userid: that.userAccount,
        },
      });
    },
    enterMyFollowPost: function () {
      let that = this;
      this.$router.push({
        path: "/TeacherCommentAndDiscussNav/TeacherAllFollowPost",
        query: {
          userid: that.userAccount,
        },
      });
